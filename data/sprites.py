...
class Sprites:
    ...
    def init(cls):
        ...
        # World objects
        cls.GRAVITY_PORTAL = pygame.transform.scale(pygame.image.load("assets/images/gravity_portal.png"), GRAVITY_PORTAL_SIZE)
        ...
        # Other
        cls.BUTTON_PLAY = pygame.image.load("assets/images/play.png")
