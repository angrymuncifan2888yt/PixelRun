...
class LevelCompleteMenu(UiObject):
    def __init__(self, position, screen_size, on_play_again=None, on_menu=None, on_levels=None):
    ...
    def _build_ui(self):
        ...
        btn_levels.center_by_x(w)
        btn_menu.center_by_x(w)

        btn_play_again.position.y = h // 2 - 60
        btn_levels.position.y = h // 2 + 10
        btn_menu.position.y = h // 2 + 80
